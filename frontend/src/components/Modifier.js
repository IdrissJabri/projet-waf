...
export const Modifier = () => {
  ...
  const Modify = () => {
    if (voyage !== null && passager !== null && finaldate !== "1-1-1970") {
      history.push(
        `/Recherche/${dataV.id}&${dataV.nom_ar}&${dataV.nom_fr}&${dataV.date}&${dataV.prix}&${dataV.psg}`
      );
    }
  };
          ...
          <div className="select-box-second">
            ...
            <Grid data-aos="fade-left">
              <Autocomplete
                ...
                options={travel.map((voyage) => {
                  return voyage.nom_fr;
                })}
                renderInput={(params) => (
                  <TextField
                    error
                    ...
                    variant="outlined"
                    helperText={voyageError ? "" : "Saisir Voyage!"}
                    required
                  />
                )}
              />
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    {...params}
                    variant="outlined"
                    helperText={passagerError ? "" : "Saisir Passager!"}
